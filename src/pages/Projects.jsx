      ...
      <div className="grid grid-cols-12 h-full ">
        <div className="lg:col-span-2 col-span-full md:col-span-3 md:border-r border-[#1E2D3D] px-0 md:px-5 md:py-4 py-0 flex flex-col gap-4 overflow-hidden">
          ...
          >
            ...
            <div className="flex items-center gap-6">
              <button
                className={`flex items-center gap-2.5 cursor-pointer transition-colors hover:text-white w-full ${filter === "Vue" ? "text-white" : "text-[#607B96]"
                  }`}
    ...
    <>
      ...
      >
        ...
        <div className="py-6 px-8 text-[#607B96] w-full flex flex-col justify-between h-[80%]">
          ...
          <motion.button
            className="bg-[#1b2b3a] text-white py-2.5 px-3.5 rounded-lg  w-max hover:bg-[#23374985]"
