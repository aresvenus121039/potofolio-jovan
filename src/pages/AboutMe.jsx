      ...
      <div className="w-full">
        <div className="grid grid-cols-12 border-b border-[#1E2D3D]">
          <div className="lg:col-span-2 md:col-span-6 col-span-12 text-white border-r border-[#1E2D3D] py-2.5 relative px-4">
            ...
            <p className="pr-5 truncate">skill.js</p>
          </div>
        </div>
      </div>
      <div className="overflow-y-auto scrollbar-thin h-full">
...
let profession = 'Blockchain | Python | Web Developer ',
                ...
                <div key={index}>
                  ...
                  <li className="flex gap-3 mb-2 mt-5">
                    {data.type?.map((data, index) => {
                      return (
                        <div
                          className="text-xs bg-[#1b2b3a] text-[16px] py-2 px-4 rounded-full flex items-center gap-1.5 w-max "
                          key={index}
                        >
