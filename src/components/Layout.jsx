      ...
      <div className="custom-size bg-[#011627]/[85%] backdrop-blur-md rounded-lg border border-[#1E2D3D] flex justify-between flex-col overflow-hidden">
        <header className="grid grid-cols-12  text-[#607B96] border-b border-[#1E2D3D] items-center">
          ...
          <div className="col-span-10 hidden lg:block">
            <nav className="flex justify-between items-center">
              <div>
                <button
                  className={`px-5 py-4 border-r border-r-[#1E2D3D] border-b-2 h-full transition-all hover:text-white ${isNavbar === "/"
                ...
                <button
                  className={`px-5 py-4 border-r border-r-[#1E2D3D] border-b-2 h-full transition-all hover:text-white ${isNavbar === "about-me"
                    ? "border-b-2 border-[#FEA55F] text-white"
                    : "border-b-transparent"
                    }`}
                  onClick={() => {
                ...
                <button
                  className={`px-5 py-4 border-r border-r-[#1E2D3D] border-b-2 h-full transition-all hover:text-white ${isNavbar === "projects"
                    ? "border-b-2 border-[#FEA55F] text-white"
                    : "border-b-transparent"
                    }`}
                  onClick={() => {
              ...
              <button
                id="border-b"
                className={`px-5 py-4 border-l border-l-[#1E2D3D] border-b-2 h-full transition-all hover:text-white ${isNavbar === "contact-me"
                  ? "border-b-2 border-[#FEA55F] text-white"
                  : "border-b-transparent"
                  }`}
                onClick={() => {
        ...
        <footer className="lg:grid grid-cols-12 text-[#607B96] border-t border-[#1E2D3D] hidden">
          <div className="col-span-2 flex items-center">
            ...
            <a
              href="https://t.me/hot_heart_beat"
              target="_blank"
              rel="noreferrer"
